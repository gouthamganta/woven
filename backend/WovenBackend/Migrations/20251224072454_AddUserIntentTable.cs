...
{
    /// <inheritdoc />
    public partial class AddUserIntentTable : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OpennessJson = table.Column<string>(type: "text", nullable: false),
                    ReflectionSentence = table.Column<string>(type: "text", nullable: false),
